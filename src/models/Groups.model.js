...
module.exports.updateGroupDescription = async function updateGroupDescription(data) {
  ...
  const { rows } = await pool.query(
    'UPDATE "Groups" SET description = $2 WHERE id = $1 RETURNING *',
    VALUES,
  );
  return rows;
};
...
module.exports.updateGroupModule = async function updateGroupModule(data) {
  ...
  const { rows } = await pool.query(
    'UPDATE "Groups" SET module = $2 WHERE id = $1 RETURNING *',
    VALUES,
  );
  return rows;
};
...
module.exports.getGroupMemberByUserID = async function getGroupMemberByUserID(data) {
  ...
  const { rows } = await pool.query(
    `SELECT * FROM "GroupMembers" INNER JOIN "Groups" ON "GroupMembers".group_id = "Groups".id 
    WHERE "GroupMembers".user_id = $1`,
    VALUES,
  );
  return rows;
};
...
module.exports.updateMemberRoleToUser = async function updateMemberRoleToUser(data) {
  ...
  const { rows } = await pool.query(
    `UPDATE "GroupMembers" SET role = 'user' WHERE group_id = $1 AND user_id = $2 RETURNING *`,
    VALUES,
  );
  return rows;
};
...
module.exports.getAllGroupDiscussionByGroupID = async function getAllGroupDiscussionByGroupID(
  data,
) {
  const VALUES = [data.group_id];
  const { rows } = await pool.query(
...
module.exports.getGroupDiscussionMatch = async function getGroupDiscussionMatch(data) {
  ...
  const { rows } = await pool.query(
    'SELECT * FROM "GroupDiscussions" WHERE group_id = $1 AND message ILIKE $2 AND channel_name = $3',
    VALUES,
  );
  return rows;
};
...
module.exports.getGroupDiscussionByGroupIDAndChannelName =
  async function getGroupDiscussionByGroupIDAndChannelName(data) {
    const VALUES = [data.group_id, data.channel_name];
    const { rows } = await pool.query(
      'SELECT * FROM "GroupDiscussions" WHERE group_id = $1 AND channel_name = $2',
      VALUES,
    );
    return rows;
  };
...
module.exports.deleteGroupChannelByChannelName = async function deleteGroupChannelByChannelName(
  data,
) {
  const VALUES = [data.group_id, data.channel_name];
  const { rows } = await pool.query(
    `DELETE FROM "GroupDiscussions" WHERE group_id = $1 AND channel_name = $2 RETURNING *`,
    VALUES,
  );
  return rows;
};
