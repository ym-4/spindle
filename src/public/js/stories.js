...
async function loadStories() {
  ...
  try {
    ...
    grid.innerHTML = stories
      .map(function (s) {
        return (
          '<div class="col-sm-6 col-md-4 col-lg-3"><div class="card shadow-sm h-100"><img src="' +
          mediaUrl(s.media_url) +
          '" class="card-img-top" style="height:200px;object-fit:cover;" alt="" /><div class="card-body p-2"><strong>' +
          esc(s.display_name || s.name) +
          '</strong>' +
          (s.caption ? '<p class="small mb-1 mt-1">' + esc(s.caption) + '</p>' : '') +
