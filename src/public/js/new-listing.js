...
async function loadItemForEditing() {
  fetchMethod(`${currentUrl}/marketplace/${editingItemId}`, (status, item) => {
...
function submitEdit(data) {
  fetchMethod(
    `${currentUrl}/marketplace/${editingItemId}`,
    async (status, responseData) => {
...
function uploadImages(itemId, files) {
  ...
  return fetch(`${currentUrl}/marketplace/${itemId}/images`, {
    method: 'POST',
...
function deleteImage(itemId, imageId) {
  return fetch(`${currentUrl}/marketplace/${itemId}/images/${imageId}`, {
    method: 'DELETE',
  }).catch((err) => console.error('Image delete error:', err));
}

function setCover(itemId, imageId) {
  return fetch(`${currentUrl}/marketplace/${itemId}/images/${imageId}/cover`, {
    method: 'PUT',
  }).catch((err) => console.error('Set cover error:', err));
}

function saveTags(itemId, tags) {
  return fetch(`${currentUrl}/marketplace/${itemId}/tags`, {
    method: 'PUT',
