...
async function fetchGroupChannels() {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/messages/channels/${groupId}`;
...
async function fetchGroupDiscussionByChannel(channel_name) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/messages/channel/${groupId}/${channel_name}`;
...
async function fetchGroupDiscussionMatch(groupId, currChannel, matchString) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/messages/match/${groupId}/${currChannel}/${matchString}`;
...
async function fetchAllUsers() {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/persons`;
...
async function fetchGroupByGroupId(groupId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/group/${groupId}`;
...
async function fetchGroupMembers(groupId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/joined/${groupId}`;
...
async function fetchGroupAnnouncements() {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/announcements/${groupId}`;
...
async function fetchGroupJoinRequests() {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/join-requests/${groupId}`;
...
async function createGroupDiscussionChannel(channel_name) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/messages/channel/${userId}`;
...
async function createGroupDiscussionMessage(message) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/messages/send/${userId}`;
...
async function updateGroupDiscussionMessage(messageId, newMessage) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/messages/edit/${userId}`;
...
async function deleteGroupDiscussionMessage(messageId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/messages/delete/${userId}`;
...
async function deleteGroupDiscussionChannel(channel_name) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/messages/channel/${groupId}`;
...
async function deleteGroupMembership() {
  ...
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/leave/${data.group_id}`;
...
async function deleteGroupMember(removedUsedId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/kick/${groupId}/${removedUsedId}`;
...
async function updateGroupAnnouncement(text, announcementId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/announcements/${groupId}/${announcementId}`;
...
async function updateGroupDescription(description) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/description/${groupId}`;
...
async function updateGroupModule(module) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/module/${groupId}`;
...
async function updateGroupPublicity(public) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/public/${groupId}`;
...
async function updateRoleToAdmin(userBeingPromotedUserId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/roleToAdmin/${groupId}/${userBeingPromotedUserId}`;
...
async function updateRoleToUser(userBeingDemotedUserId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/roleToUser/${groupId}/${userBeingDemotedUserId}`;
...
async function acceptJoinRequest(acceptedUserId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/join-requests/accept/${groupId}/${acceptedUserId}`;
...
async function declineJoinRequest(declinedUserId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/join-requests/decline/${groupId}/${declinedUserId}`;
...
async function deleteJoinRequest(beingDeletedUserId) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/join-requests/${groupId}/${beingDeletedUserId}`;
...
async function deleteGroup() {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/groups/${groupId}`;
