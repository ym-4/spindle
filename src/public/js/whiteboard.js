...
async function fetchUserWhiteboards() {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/whiteboards/user`;
...
async function fetchGroupWhiteboards() {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/whiteboards/group/${groupId}`;
...
async function fetchGroupAndUserWhiteboards() {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/whiteboards/user/${groupId}`;
...
async function fetchWhiteboardByID(id) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/whiteboards/${id}`;
...
async function createWhiteboard(data) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/whiteboards`;
...
async function updateWhiteboardDrawingData(data) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/whiteboards/${data.id}/drawing_data`;
...
async function updateWhiteboardTitle(data) {
  return new Promise((resolve, reject) => {
    const url = `${getCurrentUrl}/whiteboards/${data.id}/title`;
