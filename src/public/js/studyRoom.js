...
async function fetchAvailableCharacters() {
  return new Promise((resolve, reject) => {
    const url = 'http://localhost:3000/study-room/characters';
...
async function fetchUserCharacter() {
  return new Promise((resolve, reject) => {
    const url = 'http://localhost:3000/study-room/my-character';
...
async function fetchUserCharacterParts() {
  return new Promise((resolve, reject) => {
    const url = 'http://localhost:3000/study-room/my-character/parts';
...
function saveCharacterPart(part, option) {
  return new Promise((resolve, reject) => {
    ...
    const url = `http://localhost:3000/study-room/my-character/parts/${part}`;
